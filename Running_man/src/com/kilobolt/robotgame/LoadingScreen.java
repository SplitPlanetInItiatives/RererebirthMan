...
public class LoadingScreen extends Screen {
	...
	public void update(float deltaTime) {
		...
		Assets.character = g.newImage("stick man.png", ImageFormat.ARGB4444);
		Assets.character2 = g.newImage("stick man2.png", ImageFormat.ARGB4444);
		Assets.character3  = g.newImage("stick man3.png", ImageFormat.ARGB4444);
		...
		Assets.tiledirt = g.newImage("Pixel1.png", ImageFormat.RGB565);
		Assets.tilegrassTop = g.newImage("Pixel1.png", ImageFormat.RGB565);
		Assets.tilegrassBot = g.newImage("Pixel2.png", ImageFormat.RGB565);
		Assets.tilegrassLeft = g.newImage("Pixel3.png", ImageFormat.RGB565);
		Assets.tilegrassRight = g.newImage("Pixel4.png", ImageFormat.RGB565);
